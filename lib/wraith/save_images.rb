...
class Wraith::SaveImages
  ...
  def parallel_task(jobs)
    Parallel.each(jobs, :in_threads => (Parallel.processor_count * 1.5).floor) do |_label, _path, width, url, filename, selector, global_before_capture, path_before_capture|
      begin
